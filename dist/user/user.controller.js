...
let UserController = class UserController {
    ...
    async getUserCategories(req) {
        return this.userService.getUserCategories(req.user);
    }
    async updateUserCategories(req, updateCategoriesDto) {
        const updatedUser = await this.userService.addUserCategories(req.user, updateCategoriesDto);
        return updatedUser;
    }
};
__decorate([
